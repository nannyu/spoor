  ...
  useTranslation: () => ({
    t: (key: string, opts?: Record<string, any>) => {
      const map: Record<string, string> = {
        ...
        'lab.log_persistence': 'Persistence layer active (Dexie / IndexedDB).',
        'lab.log_env_ready': 'Research environment initialized.',
        'lab.search_preparing': 'Preparing web search…',
        'lab.search_offline_no_key': 'Offline mode — no Metaso API key configured.',
        'lab.executing_scan_drafts': 'Scanning internal drafts (4/4 complete)…',
        'lab.executing_cross_ref': 'Cross-referencing "Spatial Encoding" index (REF-042)…',
