  ...
  en: {
    translation: {
      ...
      "lab": {
        ...
        "log_persistence": "Persistence layer active (Dexie / IndexedDB).",
        "log_env_ready": "Research environment initialized.",
        "search_preparing": "Preparing web search…",
        "search_offline_no_key": "Offline mode — no Metaso API key configured.",
        "executing_scan_drafts": "Scanning internal drafts (4/4 complete)…",
        "executing_cross_ref": "Cross-referencing \"Spatial Encoding\" index (REF-042)…",
        "executing_synthesize": "Synthesizing final analytical report…",
  ...
  zh: {
    translation: {
      ...
      "lab": {
        ...
        "log_persistence": "持久层已就绪（Dexie / IndexedDB）。",
        "log_env_ready": "研究环境已初始化。",
        "search_preparing": "正在准备联网搜索…",
        "search_offline_no_key": "离线模式 — 未配置 Metaso API 密钥。",
        "executing_scan_drafts": "正在扫描内部草稿（4/4）…",
        "executing_cross_ref": "正在对照「空间编码」索引（REF-042）…",
        "executing_synthesize": "正在综合最终分析报告…",
