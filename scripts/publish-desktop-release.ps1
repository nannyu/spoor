...
git push origin $tag
Write-Host ""
Write-Host "Pushed $tag. Watch: https://github.com/iimorning/scribe-ai-canvas/actions"
Write-Host "When green, download: https://github.com/iimorning/scribe-ai-canvas/releases/latest"
